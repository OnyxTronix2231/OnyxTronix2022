...
public class PathRedDownTwoBalls implements AutonomousPaths {

    static final double X_START_POSE = 10; // TODO: check
    static final double X_FIRST_BALL = 11.339;

    static final double Y_START_POSE = 3; // TODO: check
