...
public class PathBlueCloseClimberStraightLine implements AutonomousPaths {
    ...
    public PathBlueCloseClimberStraightLine() {
        ...
        firstPath = new Path(
                List.of(),
                new Pose2d(X_FIRST_POINT, Y_FIRST_POINT, Rotation2d.fromDegrees(DESTINATION_DEGREE)),
