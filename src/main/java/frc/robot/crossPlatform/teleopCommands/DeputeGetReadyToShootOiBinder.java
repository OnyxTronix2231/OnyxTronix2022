...
import frc.robot.providers.IsDeputeGetReadyButtonPress;
...
public class DeputeGetReadyToShootOiBinder {
    ...
    public DeputeGetReadyToShootOiBinder(Shooter shooter, Arc arc, YawControl yawControl,
        ...
        getReady.whileActiveContinuous(new GetReadyToShoot(shooter, arc, yawControl, distanceSupplier, angleSupplier)
                .alongWith(new InstantCommand(()-> IsDeputeGetReadyButtonPress.setPress(true))));
        getReady.whenInactive(new InstantCommand(()-> IsDeputeGetReadyButtonPress.setPress(false)));
    }
}
