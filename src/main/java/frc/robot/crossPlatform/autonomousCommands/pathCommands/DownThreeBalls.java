...
public class DownThreeBalls extends SequentialCommandGroup {
    public DownThreeBalls(DriveTrain driveTrain, Intake frontIntake, Intake backIntake, Loader loader,
        ...
        super(
                ...
                new AutoMoveAndIntake(driveTrain, frontIntake, backIntake, loader, ballTrigger, PATH_B_BLUE_SECOND_BALL),
